...
const projects: Project[] = [
  ...
  },
  {
    ...
    logoInitial: "O",
    links: [{ label: "CODE", href: "https://github.com/team-obi/OBI" }],
  },
  {
    no: "#003",
    name: "SIGNALFORGE",
    ...
    links: [{ label: "CODE", href: "https://github.com/sewonm/BerkeleyAIHackathon2026" }],
    logoInitial: "S",
  },
  {
    no: "#004",
    ...
    logoInitial: "T",
    links: [{ label: "CODE", href: "https://github.com/Eddiewithaneye/touchgrass" }],
  },
];
        ...
        {projects.map((p) => (
          ...
          >
            ...
            <header className="flex items-start gap-3 mt-1">
              <OrgLogo domain={p.logoDomain} initial={p.logoInitial} accent={ACCENT} />
